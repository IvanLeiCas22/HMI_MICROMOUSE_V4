...
namespace {
struct qt_meta_stringdata_UnerbusParser_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UnerbusParser_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UnerbusParser_t qt_meta_stringdata_UnerbusParser = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_UnerbusParser[] = {
...
Q_CONSTINIT const QMetaObject UnerbusParser::staticMetaObject = { {
    ...
    qt_meta_stringdata_UnerbusParser.offsetsAndSizes,
    qt_meta_data_UnerbusParser,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UnerbusParser_t,
        // Q_OBJECT / Q_GADGET
...
void *UnerbusParser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UnerbusParser.stringdata0))
