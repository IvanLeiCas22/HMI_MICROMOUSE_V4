...
static constexpr auto qt_meta_stringdata_CLASSUnerbusENDCLASS = QtMocHelpers::stringData(
    "Unerbus",
    "CommandId",
    "CMD_ACK",
    "CMD_GET_ALIVE",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSUnerbusENDCLASS_t qt_meta_stringdata_CLASSUnerbusENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSUnerbusENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Unerbus::staticMetaObject = { {
    nullptr,
    qt_meta_stringdata_CLASSUnerbusENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSUnerbusENDCLASS,
    nullptr,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSUnerbusENDCLASS_t,
        // enum 'CommandId'
        QtPrivate::TypeAndForceComplete<Unerbus::CommandId, std::true_type>,
        // Q_OBJECT / Q_GADGET
