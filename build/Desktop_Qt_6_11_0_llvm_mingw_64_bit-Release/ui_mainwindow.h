...
public:
    ...
    QLabel *lblWallRightDetected;
    QLabel *lblWallLeftDetected;
    QLabel *label_10;
    QFrame *line_6;
    ...
    QLabel *lblWallDiagRightDetected;
    QLabel *lblWallDiagLeftDetected;
    QLabel *label_9;
    QFrame *line_3;
    ...
    QLabel *lblFloorFrontDetected;
    QLabel *lblFloorRearDetected;
    ...
    QLabel *label_46;
    QLabel *label_50;
    QLineEdit *editKpSmoothTurn;
    QLineEdit *editKiSmoothTurn;
    QLineEdit *editKdSmoothTurn;
    QLabel *label_51;
    QLineEdit *editTurnAngularSpeed;
...
"  margin: 8px;\n"
"}"));
        navigationFrame->setFrameShape(QFrame::Shape::StyledPanel);
        navigationFrame->setFrameShadow(QFrame::Shadow::Plain);
...
"}"));
        ...
        titleHome->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        localPortLabel->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
        ...
        RemoteIPLabel->setAlignment(Qt::AlignmentFlag::AlignLeading|Qt::AlignmentFlag::AlignLeft|Qt::AlignmentFlag::AlignVCenter);
        ...
        labelCommStatus->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        titleSensors->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        progBarIrLeftSide->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        progBarIrRightSide->setAlignment(Qt::AlignmentFlag::AlignCenter);
        progBarIrRightSide->setTextVisible(true);

        layoutDistanceSensors->addWidget(progBarIrRightSide, 0, 1, 1, 1);

        lblWallRightDetected = new QLabel(groupIRSensors);
        lblWallRightDetected->setObjectName("lblWallRightDetected");
        lblWallRightDetected->setMinimumSize(QSize(30, 0));

        layoutDistanceSensors->addWidget(lblWallRightDetected, 0, 2, 1, 1);

        lblWallLeftDetected = new QLabel(groupIRSensors);
        lblWallLeftDetected->setObjectName("lblWallLeftDetected");
        lblWallLeftDetected->setMinimumSize(QSize(30, 0));

        layoutDistanceSensors->addWidget(lblWallLeftDetected, 5, 2, 1, 1);
        ...
        progBarIrFrontRight->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        progBarIrFrontLeft->setAlignment(Qt::AlignmentFlag::AlignCenter);
        progBarIrFrontLeft->setTextVisible(true);

        gridLayout_2->addWidget(progBarIrFrontLeft, 1, 1, 1, 1);

        lblWallFrontDetected = new QLabel(groupIRSensors);
        lblWallFrontDetected->setObjectName("lblWallFrontDetected");
        lblWallFrontDetected->setMinimumSize(QSize(30, 0));

        gridLayout_2->addWidget(lblWallFrontDetected, 0, 2, 1, 1);
        ...
        progBarIrLeftDiag->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        progBarIrRightDiag->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        lblWallDiagRightDetected = new QLabel(groupIRSensors);
        lblWallDiagRightDetected->setObjectName("lblWallDiagRightDetected");
        lblWallDiagRightDetected->setMinimumSize(QSize(30, 0));

        gridLayout_3->addWidget(lblWallDiagRightDetected, 0, 2, 1, 1);

        lblWallDiagLeftDetected = new QLabel(groupIRSensors);
        lblWallDiagLeftDetected->setObjectName("lblWallDiagLeftDetected");
        lblWallDiagLeftDetected->setMinimumSize(QSize(30, 0));

        gridLayout_3->addWidget(lblWallDiagLeftDetected, 1, 2, 1, 1);
        ...
        progBarIrGroundFront->setMinimum(0);
        progBarIrGroundFront->setMaximum(4095);
        progBarIrGroundFront->setValue(0);
        progBarIrGroundFront->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        progBarIrGroundRear->setMinimum(0);
        progBarIrGroundRear->setMaximum(4095);
        progBarIrGroundRear->setValue(0);
        progBarIrGroundRear->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        lblFloorFrontDetected = new QLabel(groupIRSensors);
        lblFloorFrontDetected->setObjectName("lblFloorFrontDetected");
        lblFloorFrontDetected->setMinimumSize(QSize(30, 0));

        layoutGroundSensors->addWidget(lblFloorFrontDetected, 0, 2, 1, 1);

        lblFloorRearDetected = new QLabel(groupIRSensors);
        lblFloorRearDetected->setObjectName("lblFloorRearDetected");
        lblFloorRearDetected->setMinimumSize(QSize(30, 0));

        layoutGroundSensors->addWidget(lblFloorRearDetected, 3, 2, 1, 1);
        ...
        groupBoxMpuConfig = new QGroupBox(groupMPU6050);
        groupBoxMpuConfig->setObjectName("groupBoxMpuConfig");
        groupBoxMpuConfig->setFont(font6);
        ...
        verticalLayout_9->addWidget(groupBoxMpuConfig);
        ...
        titleConfig->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        gridLayout_7->addWidget(label_49, 4, 0, 1, 1);
        ...
        gridLayout_7->addWidget(label_48, 3, 0, 1, 1);
        ...
        gridLayout_7->addWidget(label_50, 5, 0, 1, 1);

        editKpSmoothTurn = new QLineEdit(groupBox_5);
        editKpSmoothTurn->setObjectName("editKpSmoothTurn");

        gridLayout_7->addWidget(editKpSmoothTurn, 3, 1, 1, 1);

        editKiSmoothTurn = new QLineEdit(groupBox_5);
        editKiSmoothTurn->setObjectName("editKiSmoothTurn");

        gridLayout_7->addWidget(editKiSmoothTurn, 4, 1, 1, 1);

        editKdSmoothTurn = new QLineEdit(groupBox_5);
        editKdSmoothTurn->setObjectName("editKdSmoothTurn");

        gridLayout_7->addWidget(editKdSmoothTurn, 5, 1, 1, 1);

        label_51 = new QLabel(groupBox_5);
        label_51->setObjectName("label_51");

        gridLayout_7->addWidget(label_51, 4, 2, 1, 1);

        editTurnAngularSpeed = new QLineEdit(groupBox_5);
        editTurnAngularSpeed->setObjectName("editTurnAngularSpeed");

        gridLayout_7->addWidget(editTurnAngularSpeed, 4, 3, 1, 1);
        ...
        titleHome_2->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        hSliderRightMotorNeg->setOrientation(Qt::Orientation::Horizontal);
        ...
        hSliderRightMotorPos->setOrientation(Qt::Orientation::Horizontal);
        hSliderRightMotorPos->setInvertedAppearance(false);
        hSliderRightMotorPos->setInvertedControls(false);
        hSliderRightMotorPos->setTickPosition(QSlider::TickPosition::NoTicks);
        ...
        hSliderLeftMotorPos->setOrientation(Qt::Orientation::Horizontal);
        ...
        hSliderLeftMotorNeg->setOrientation(Qt::Orientation::Horizontal);
        hSliderLeftMotorNeg->setTickPosition(QSlider::TickPosition::NoTicks);
        ...
        titleLabyrinth->setAlignment(Qt::AlignmentFlag::AlignCenter);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lblWallRightDetected->setText(QString());
        lblWallLeftDetected->setText(QString());
        ...
        lblWallFrontDetected->setText(QString());
        ...
        lblWallDiagRightDetected->setText(QString());
        lblWallDiagLeftDetected->setText(QString());
        ...
        lblFloorFrontDetected->setText(QString());
        lblFloorRearDetected->setText(QString());
        ...
        groupBoxMpuConfig->setTitle(QCoreApplication::translate("MainWindow", "Configuraci\303\263n", nullptr));
        ...
        editRightMotorBaseSpeed->setText(QCoreApplication::translate("MainWindow", "3600", nullptr));
        label_26->setText(QCoreApplication::translate("MainWindow", "Motor izquierdo", nullptr));
        editLeftMotorBaseSpeed->setText(QCoreApplication::translate("MainWindow", "3600", nullptr));
        ...
        editAccelThreshold->setText(QCoreApplication::translate("MainWindow", "2000", nullptr));
        label_42->setText(QCoreApplication::translate("MainWindow", "Ticks Confirmaci\303\263n (x10ms):", nullptr));
        editConfirmTicks->setText(QCoreApplication::translate("MainWindow", "0", nullptr));
        ...
        editWallFadeTicks->setText(QCoreApplication::translate("MainWindow", "0", nullptr));
        ...
        editSetpointDiagonal->setText(QCoreApplication::translate("MainWindow", "110", nullptr));
        ...
        editSetpointFront->setText(QCoreApplication::translate("MainWindow", "100", nullptr));
        ...
        editMinTurnSpeed->setText(QCoreApplication::translate("MainWindow", "300", nullptr));
        ...
        editKpBraking->setText(QCoreApplication::translate("MainWindow", "4", nullptr));
        ...
        editBrakingMaxSpeed->setText(QCoreApplication::translate("MainWindow", "2800", nullptr));
        label_braking_min_speed->setText(QCoreApplication::translate("MainWindow", "Velocidad M\303\255n. Frenado:", nullptr));
        editBrakingMinSpeed->setText(QCoreApplication::translate("MainWindow", "2000", nullptr));
